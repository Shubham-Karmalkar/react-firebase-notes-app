    ...
    <div className={`${style.sidebar_container} ${className}`}>
      <ul>
        ...
        <ul className={style.sidebar_scroll}>
          <li>
            <Link to="#" className={`${style.links} ${style.notes}`}>
              <GiNotebook />
          ...
          <li>
            <img className={style.logo} src={goUpgradeLogo} alt="go upgrade" />
          </li>
          <li>Upgrade To Pro Account To Explore Premiun Features</li>
          <li className={style.upgradeBtn}>
