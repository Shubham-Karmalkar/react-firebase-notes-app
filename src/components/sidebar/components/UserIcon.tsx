  ...
  return (
    <>
      <span className={style.links}>
        <Link to="#"><CgProfile/><span>My Profile</span></Link>
      </span>
      <span className={style.links}>
        <Link to="#"><LiaUserEditSolid/>Edit Profile</Link>
      </span>
      <span className={style.links}>
        <Link to="#"><GrUserSettings/>Account Settings</Link>
      </span>
      <span className={style.links}>
        <Link to="#"><TbUserShield/>Privacy Settings</Link>
      </span>
      <span onClick={logOut} className={style.logout}><span><AiOutlineLogout/>Logout</span></span>
    </>
  );
};
